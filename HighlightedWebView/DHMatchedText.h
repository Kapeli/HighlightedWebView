...
static NSString *DHHighlightSpan = @"background: -webkit-gradient(linear, 0% 0%, 0% 100%, from(rgba(244, 234, 38, 0.7)), to(rgba(237, 206, 0, 0.7)) );display:inline;position:static;margin:0px 0px 0px 0px;padding:0px 0px 0px 0px;opacity:1.0;";
